...
final class BattleWebSocketHandler extends TextWebSocketHandler implements SubProtocolCapable {
    ...
    BattleWebSocketHandler(BattleMatchViewService views, ObjectMapper objectMapper) {
    ...
    private static <T> T requiredAttribute(WebSocketSession session, String name, Class<T> type) {
