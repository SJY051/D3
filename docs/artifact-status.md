...
| 5 | Service database ERD | [Logical ERD](architecture/erd.dbml) | Service owners | Logical baseline: 25 tables, 13 intra-service refs | 2026-08-13 · federation and contract-enum review | Rendered diagram, Flyway migrations and query/index evidence |
