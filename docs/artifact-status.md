...
| 5 | Service database ERD | [Logical ERD](architecture/erd.dbml) | Service owners | Logical baseline: 31 tables, 19 intra-service refs; four forward-only Flyway chains | 2026-08-14 · fresh install, adversarial existing-data upgrade, ownership invariants and Testcontainers review | Rendered diagram, legacy cleanup validation and feature query-plan evidence |
