...
| 5 | Service database ERD | [Logical ERD](architecture/erd.dbml) | Service owners | Logical baseline: 26 tables, 17 intra-service refs; four forward-only Flyway chains | 2026-08-14 · fresh install, existing-data upgrade, ownership invariants and Testcontainers review | Rendered diagram and feature query-plan evidence |
