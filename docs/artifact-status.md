...
| 5 | Service database ERD | [Logical ERD](architecture/erd.dbml) | Service owners | Logical baseline: 32 tables, 20 intra-service refs; four forward-only Flyway chains | 2026-08-16 · Community V4 duplicate-reference normalization, result-post uniqueness and ACTIVE player-record indexes | Rendered diagram, remaining legacy cleanup validation and production query-plan evidence |
