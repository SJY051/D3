...
Last verified: 2026-08-13 against `docs/specs/d3-mvp.md` and versioned contract stubs
...
sequenceDiagram
  ...
  BT->>BT: Lock accepted submission and determine outcome
