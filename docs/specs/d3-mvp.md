...
| M-05 | 7 | A committed result explains speed, dynamic efficiency and submission discipline without claiming measured Big-O | D3-BTL-003 | Formula examples, boundary tests and repeatability sample | PARTIAL PASS: Battle has a deterministic, versioned 50/35/15 domain calculator with fixed one-solve, both-solve, neither-solve, exact-tie and void examples; Judge persists privacy-safe repeated size-tier evidence. Battle persistence, designated-host calibration and an integrated repeatability sample remain PENDING |
...
| M-07 | 7 | A ranked result updates public rating and separate seasonal RP/tier exactly once | D3-BTL-005 | Rating/RP tests and idempotent persistence evidence | PARTIAL PASS: replaceable placement/established rating factors, separate RP, five-match `Unranked` boundary, tier/division mapping and void/unranked no-op have fixed domain tests; transactional exactly-once persistence and outbox remain PENDING |
