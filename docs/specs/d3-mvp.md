...
| M-04 | 7 | Run and Submit use an isolated Judge0 boundary with six explicit language mappings and classified failures | D3-JDG-001 | Six runtime smokes and failure normalization tests | Judge v1 contract and fake normalization tests; real runtime versions `UNKNOWN` |
