...
| Battle realtime projection privacy | PASS in unit and contract tests; transport PENDING | Participant lookup returns not-found for outsiders; the closed v1 snapshot excludes source, connection fencing generations and private incident references. WebSocket credential transport and destination authorization remain issue #27/#15 work |
